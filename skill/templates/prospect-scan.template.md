...
**This skill carries method only.** The org's geography, priorities, populations, and eligibility traps live in **Org Profile** and are read at runtime.

---

## Step 0 - Read the judgment layer from Org Profile (first, every time)

Read the single Org Profile record. Load: **Search Geography**, **Funding Priority Order**, **Populations Served**, **Programs + Maturity**, **Recurring Eligibility Traps**, **Stage Posture**.
...
Order by realistic yield, applying the Funding Priority Order from Org Profile:
...
Use the tiered terms from Org Profile's Search Geography, combined with issue-area keywords drawn from Populations Served and Programs + Maturity.
...
- **Stage = Archived / Withdrawn** -> already dispositioned; do not resurface unless materially changed. If it genuinely reopened or changed, note that it was previously archived and why.
